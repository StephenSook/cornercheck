...
export const BEATS: Beat[] = [
  {
    ...
    to: 22,
    mode: "camera",
    footage: undefined, // camera-beat0.mp4
    script:
  ...
  },
  {
    ...
    to: 48,
    mode: "voiceover",
    footage: undefined, // beat2-card-board.mp4
    script:
  ...
  },
  {
    ...
    to: 72,
    mode: "voiceover",
    footage: undefined, // beat3-jds-texas.mp4
    script:
  ...
  },
  {
    ...
    to: 90,
    mode: "voiceover",
    footage: undefined, // beat4-bruno-pick.mp4
    script:
  ...
  },
  {
    ...
    to: 107,
    mode: "voiceover",
    footage: undefined, // beat5-garcia-live.mp4
    script:
  ...
  },
  {
    ...
    to: 125,
    mode: "voiceover",
    footage: undefined, // beat6-z3-proof.mp4
    script:
  ...
  },
  {
    ...
    to: 140,
    mode: "voiceover",
    footage: undefined, // beat7-canvas-export.mp4
    script:
  ...
  },
  {
    ...
    to: 153,
    mode: "voiceover",
    footage: undefined, // beat8-ops-digest.mp4
    script:
  ...
  },
  {
    ...
    to: 163,
    mode: "voiceover",
    footage: undefined, // beat9-dashboard.mp4
    script:
  ...
  },
  {
    ...
    to: 173,
    mode: "camera",
    footage: undefined, // camera-beat10.mp4
    script:
